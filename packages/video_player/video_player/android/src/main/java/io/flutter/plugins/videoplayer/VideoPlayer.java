...
final class VideoPlayer {
  public static final class HeadersHttpDataSourceFactory extends HttpDataSource.BaseFactory {
    ...
    public HeadersHttpDataSourceFactory(
            String userAgent,
    ...
    protected HttpDataSource createDataSourceInternal(HttpDataSource.RequestProperties defaultRequestProperties) {
      ...
      dataSource.setRequestProperty("test2", "test2");
  ...
  VideoPlayer(
    ...
    if (isHTTP(uri)) {
      dataSourceFactory =
          new HeadersHttpDataSourceFactory(
              "ExoPlayer",
              null,
